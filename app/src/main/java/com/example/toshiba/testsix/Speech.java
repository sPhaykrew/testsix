...
public class Speech extends UtteranceProgressListener implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {

    public static Speech myTTS;

    public static Speech getInstance(Context context) {
        if (myTTS == null) {
            myTTS = new Speech(context);
        }
        return myTTS;
    }
    ...
    public Speech setEngine(String packageName) {
